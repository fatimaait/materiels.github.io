...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'materiels_028e1580a74a2f0a9945_20211110114036_archive.zip';
	const ARCHIVE_SIZE		 = '103121001';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '028e158-10114036';
    const SECONDARY_PACKAGE_HASH = 'fa29381-10114036';
	const VERSION			 = '1.4.3';
